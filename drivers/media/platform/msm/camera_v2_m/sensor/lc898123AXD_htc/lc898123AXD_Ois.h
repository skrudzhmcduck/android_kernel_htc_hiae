...
typedef struct STRECALIB {
	unsigned short	SsFctryOffX ;
	unsigned short	SsFctryOffY ;
	unsigned short	SsRecalOffX ;
	unsigned short	SsRecalOffY ;
	unsigned short	SsDiffX ;
	unsigned short	SsDiffY ;
} stReCalib ;
...
OISCMD__	int 	FlashNVRSectorErase_Byte( unsigned short );
...
OISCMD__	void 	FlashNVR_ReadData_ByteA( unsigned short, unsigned char *, unsigned short );
OISCMD__	void 	FlashNVR_ReadData_Byte( unsigned char, unsigned char, unsigned char *, unsigned short );
...
OISCMD__	unsigned short MakeNVRSelIdx( unsigned short UsAddress );
#if 0
